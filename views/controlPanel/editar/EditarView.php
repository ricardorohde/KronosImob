        ...
        <form method="POST" enctype="multipart/form-data" action="">
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <label>Título</label>
                    <input class="form-control" type="text" name="titulo" value="<?php echo $model->form_data['titulo']; ?>" />

                    <label>Descrição</label>
                    <textarea class="form-control" name="descricao" rows="10" ><?php echo $model->form_data['descricao']; ?></textarea>
                    ...
                    <div class="row">
                        <div class="col-lg-3">
                            ...
                            <input class="form-control" type="number" name="n_Quartos" value="<?php echo $model->form_data['n_Quartos']; ?>" />

                        </div>
                        <div class="col-lg-3">

                            <label>Nº de banheiros</label>
                            <input class="form-control" type="number" name="n_Banheiros" value="<?php echo $model->form_data['n_Banheiros']; ?>" />
